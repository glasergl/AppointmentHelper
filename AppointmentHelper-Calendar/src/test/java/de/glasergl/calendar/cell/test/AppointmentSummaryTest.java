...
public class AppointmentSummaryTest {
	...
	public void testSpecialCaseOfNameLength() {
		...
		assertEquals("Ein Geburtstag",
				AppointmentSummary.getSummary(Arrays.asList(new Appointment(testDate1, specialCaseWord, true))));
	}

	@Test
	public void testSpecialCaseWithoutBirthday() {
		String specialCaseWord = "MMMMMMMMMMMMMMMM";
		assertEquals("Ein Termin",
				AppointmentSummary.getSummary(Arrays.asList(new Appointment(testDate1, specialCaseWord, false))));
	}
	...
	public void testWithThree() {
		...
		assertEquals("3 Geburtstage",
				AppointmentSummary.getSummary(Arrays.asList(appointment1, appointment2, appointment3)));
	}

...
public class TestCreateConfigurationFile {
	...
	public void testConfigurationAfterCreateConfigurationFile() {
		final File emptyConfigurationFile = ConfigurationHandler.createConfigurationFile(
				BASE_TEST_RESOURCE_PATH + "testConfigurationAfterCreateConfigurationFile-Configuration.json");
	...
	public void testCreateConfigurationFileWhichAlreadyExists() {
		final String path = BASE_TEST_RESOURCE_PATH
				+ "testCreateConfigurationFileWhichAlreadyExists-Configuration.json";

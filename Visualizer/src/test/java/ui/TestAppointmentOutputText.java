...
public class TestAppointmentOutputText {
    ...
    @Test
    public void test00() {
	List<Appointment> appointments = getTestAppointmentsWithDates(SimpleDate.getDateIn(122), SimpleDate.getDateIn(13), SimpleDate.getDateIn(54),
		SimpleDate.getDateIn(16));
    ...
    @Test
    public void test01() {
	List<Appointment> appointments = getTestAppointmentsWithDates(SimpleDate.getDateIn(122), SimpleDate.getDateIn(13), SimpleDate.getToday(),
		SimpleDate.getDateIn(16));
	AppointmentOutputText output = new AppointmentOutputText("Heute", Appointment::isToday, appointments);
    ...
    @Test
    public void test10() {
	List<Appointment> appointments = getTestAppointmentsWithDates(SimpleDate.getToday(), SimpleDate.getDateIn(13), SimpleDate.getDateIn(54),
		SimpleDate.getDateIn(16));
	AppointmentOutputText output = new AppointmentOutputText("Heute", Appointment::isToday, appointments);
    ...
    @Test
    public void test11() {
	List<Appointment> appointments = getTestAppointmentsWithDates(SimpleDate.getToday(), SimpleDate.getDateIn(13), SimpleDate.getToday(),
		SimpleDate.getDateIn(16));
	AppointmentOutputText output = new AppointmentOutputText("Heute", Appointment::isToday, appointments);
    ...
    @Test
    public void test22() {
	List<Appointment> appointments = getTestAppointmentsWithDates(SimpleDate.getToday(), SimpleDate.getToday(), SimpleDate.getToday(),
		SimpleDate.getToday());
	AppointmentOutputText output = new AppointmentOutputText("Heute", Appointment::isToday, appointments);
    ...
    @Test
    public void test20() {
	List<Appointment> appointments = getTestAppointmentsWithDates(SimpleDate.getToday(), SimpleDate.getToday(), SimpleDate.getDateIn(54),
		SimpleDate.getDateIn(16));
	AppointmentOutputText output = new AppointmentOutputText("Heute", Appointment::isToday, appointments);

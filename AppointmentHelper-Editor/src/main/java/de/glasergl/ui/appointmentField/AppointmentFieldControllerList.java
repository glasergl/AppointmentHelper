...
public final class AppointmentFieldControllerList extends JPanel {
	...
	public void addEmptyAppointmentField() {
		final AppointmentFieldController appointmentFieldController = new AppointmentFieldController(this,
	...
	public Dimension getPreferredViewSize() {
		...
		return new Dimension((int) (preferredSizeOfDummy.width * 1.05),
				(int) (MAX_NUMBER_OF_SHOWN_APPOINTMENTS - 0.5) * preferredSizeOfDummy.height);
	}

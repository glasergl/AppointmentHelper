...
public final class AppointmentFieldController extends JPanel {
     ...
     */
    private AppointmentFieldController(final AppointmentFieldControllerList appointmentFieldList, final Optional<Appointment> initialDisplay, final int initialIndex) {
	super();
	this.appointmentFieldList = appointmentFieldList;
	this.appointmentField = initialDisplay.isPresent() ? new AppointmentField(initialDisplay.get()) : new AppointmentField();
    ...
    public AppointmentFieldController(final AppointmentFieldControllerList parent, final Appointment initialDisplay, final int initialIndex) {

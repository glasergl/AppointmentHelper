...
public class AllMonths extends JPanel {
	...
	this.displayOfCurrentMonth = new MonthRepresentation(toSetSelectedDateOf.getMonthPopUp(), toSetSelectedDateOf, currentMonth);
	setupButtons();
	...
	displayOfCurrentMonth = new MonthRepresentation(toSetSelectedDateOf.getMonthPopUp(), toSetSelectedDateOf, currentMonth);

...
public class AllAppointments extends JPanel {
	...
	final int widthOfVerticalScrollBar = (int) whichContainsAllAppointments.getVerticalScrollBar().getPreferredSize().getWidth();
	...
	whichContainsAllAppointments.setPreferredSize(new Dimension(preferredWidthOfScrollPane, preferredHeightOfScrollPane));
    }

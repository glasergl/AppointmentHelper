...
public final class AppointmentFieldWrapperList extends JPanel {
     ...
     *
     * @throws IllegalStateException If at least one appointment field doesn't
     *                               contain a valid appointment as input.
     */
    public void storeAll() throws IllegalStateException {
     ...
     *                               contain a valid appointment as input.
     */
    public List<Appointment> getInput() throws IllegalStateException {
